...
namespace Agot2Client
{
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private void Window_Initialized(object sender, EventArgs e)
        {
            ...
            try
            {
                UpdaterClient = new UpdaterClient("lantsev1981.pro:6999", "Agot2Client.exe", "AGOT: Online BG");
                bool? result = UpdaterClient.Update();
                if (result != true)
                {
                    try
                    {
                        Process.Start($"http://lantsev1981.pro/{CultureInfo.CurrentUICulture.Name.Substring(0, 2)}/home/LastNews");
                    }
                    catch { }
