...
namespace Agot2Client
{
    ...
    public partial class ApiWindow : Window
    {
        ...
        {
            DialogResult = new FacebookWindow().ShowDialog();
        }

        private void VkButton_Click(object sender, RoutedEventArgs e)
        {
            DialogResult = new VkAuthWindow().ShowDialog();
        }
        ...
        private void Help_Button_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                Process.Start($"https://lantsev1981.pro/{CultureInfo.CurrentUICulture.Name.Substring(0, 2)}/wiki/index/99e1439a-0f0b-4a85-8085-ff8c355c4d81#errorList");
                //Process.Start("https://www.facebook.com/lantsev1981");
            }
            catch { }
        }
    }
